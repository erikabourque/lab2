...
public class LoanCalculator {
    ...
    public LoanCalculator(double loanAmount, int numberOfYears, double yearlyInterestRate) {
        ...
        if ((numberOfYears < 1) || (numberOfYears > 25))
        {
            throw new IllegalArgumentException("Loan duration must be between 1 and 25 years.");
        }

        if ((yearlyInterestRate <= 0) || (yearlyInterestRate > 100))
        {
            throw new IllegalArgumentException("Interest rate must be between 1 and 100");
        }
